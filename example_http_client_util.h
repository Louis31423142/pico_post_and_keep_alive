...
typedef struct EXAMPLE_HTTP_REQUEST {
     ...
     */
    int (*result_fn)(struct EXAMPLE_HTTP_REQUEST *req, httpc_result_t httpc_result, u32_t rx_content_len, u32_t srv_res, err_t err);
    /*!
 ...
 * @see async_context
 */
int http_client_get_request_async(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req);

int http_client_post_request_async(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req, u16_t data_len, const char *data);
 ...
 */
int http_client_get_request_sync(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req);

int http_client_post_request_sync(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req, u16_t data_len, const char *data);
